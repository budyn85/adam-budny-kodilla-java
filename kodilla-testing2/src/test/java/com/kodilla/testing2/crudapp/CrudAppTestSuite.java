...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://budyn85.github.io/";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    ...
                    WebElement buttonCreateElement =
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("adam.kodilla@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Kodilla@2018");
